...
public class verifyenterotptwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       final ProgressBar progressBarvarifyotp = findViewById(R.id.progressbar_verify_otp);
            ...
            public void onClick(View view) {
                ...
                if(!inputnumber1.getText().toString().trim().isEmpty() && !inputnumber2.getText().toString().trim().isEmpty()){
                   ...
                   if(getotpbackend!=null){
                       progressBarvarifyotp.setVisibility(View.VISIBLE);
                       ...
                       FirebaseAuth.getInstance().signInWithCredential(phoneAuthCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                           ...
                           public void onComplete(@NonNull Task<AuthResult> task) {
                               progressBarvarifyotp.setVisibility(View.GONE);
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onCodeSent(@NonNull String newbackendotp, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                ...
                                Toast.makeText(verifyenterotptwo.this, "Otp Resent", Toast.LENGTH_SHORT).show();
                            }
                        }
                );
